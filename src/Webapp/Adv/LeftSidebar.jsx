...
function NavItem({ icon, label, active = false }) {
    ...
    return (
        <div
            className={`flex items-center gap-3 px-4 py-3 rounded-lg cursor-pointer hover:bg-purple-100 ${
        ...
        <div className="w-64 bg-white p-6 flex flex-col h-screen sticky top-0">
            ...
            <div className="flex items-center gap-2 mb-10">
                <div className="h-12 w-12 bg-purple-500 rounded-lg flex items-center justify-center overflow-hidden">
                    <img
                        ...
                        className="h-full w-full object-contain" // Ensure the image fits well
                    />
                </div>
            ...
            <div className="mt-auto">
                <div className="bg-gray-100 p-4 rounded-lg text-center">
                    ...
                    <button className="w-full bg-purple-500 text-white py-2 px-4 rounded-md flex items-center justify-center gap-2 hover:bg-purple-600 transition">
                        Publish
            ...
            <button
                ...
                className="bg-red-500 text-white w-full py-2 mt-4 rounded-md hover:bg-red-600 transition"
            >
                Log Out
            </button>
